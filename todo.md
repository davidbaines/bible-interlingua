...
- [x] `ms4_ie_shareable`; fetch; results doc vs 47.01/37.03/43.82.
      Gate: ≥ baseline.
- [ ] `ms8_ie_shareable` (if gate passes); pick winner K.
- [ ] `experiments/ms-results.md`.

### 5. Phase 2 — anchors + attach
- [x] `anchors.py` + retrieval sanity test (>95%).
- [x] `attach.py` (graft: tied-row + adapters + gradient mask + checksum
...
- Key citations: see `project-brief.md` (Zhou 2021; Setiawan 2026; Escolano
  2019-21; SONAR/T-Modules; Bérard 2021; MTOB critique 2024).- [x]do
